...
class Game: NSObject {
    ...
    func getPawnToBePromoted() -> Piece?{
    ...
    func getArrayOfPossibleMoves(forPiece piece: Piece) -> [BoardIndex]{
    ...
    func isNormalMoveValid(forPiece piece: Piece, fromIndex source: BoardIndex, toIndex destination: BoardIndex, canAttackAllies: Bool = false) -> Bool{
    ...
    func didBestMoveForAI(forScoreOver limit: Int) -> Bool{
        ...
        for aChessPiece in board.vc.chessPieces{
            ...
            for dest in possibleDestinations{
                ...
                board.board[source.row][source.col] = Piece(index: source, board: self.board)
    ...
    func getScoreForLocation(ofPiece aChessPiece: Piece) -> Int{
...
//    func makeAIMove(){
//        //get the black king, if possible
//        if getPlayerChecked() == "White"{
//            for piece in board.vc.chessPieces{
//                if !piece.isWhite{
//
//                    guard let source = piece.index else{
//                        continue
//                    }
//
//                    guard let dest = board.blackKing.index else{
//                        continue
//                    }
//
//                    if isNormalMoveValid(forPiece: piece, fromIndex: source, toIndex: dest){
//                        move(piece: piece, sourceIndex: source, destIndex: dest)
//                        print("AI: ATTACK BLACK KING")
//                        return
//                    }
//                }
//            }
//        }
//        
//        //attack undefended white piece, if there's no check on the white king
//        if getPlayerChecked() == nil{
//            if didAttackUndefendedPiece(){
//                print("AI: ATTACK UNDEFENDED PIECE")
//                return
...
//            
//            if numberOfTriesToEscapeCheck < 1000{
//                guard getPlayerChecked() != "White" else {
//                    //undo move
//                    board.board[sourceIndex.row][sourceIndex.col] = board.board[randDestIndex.row][randDestIndex.col]
//                    board.board[randDestIndex.row][randDestIndex.col] = pieceTaken
//
...
//                print("AI: RANDOM MOVE TO ESCAPE CHECK")
//            }
//            move(piece: pieceTaken, sourceIndex: sourceIndex, destIndex: randDestIndex)
//            moveFound = true
//        }
//    }
//
...
//            let possibleDestinations = getArrayOfPossibleMoves(forPiece: attackingChessPiece)
//
//            searchForUndefendedBlackPieces: for attackedIndex in possibleDestinations{
//
//                let attackedChessPiece = board.board[attackedIndex.row][attackedIndex.col]
//                
//                if attackedChessPiece.geometry is SCNSphere{
//                    continue searchForUndefendedBlackPieces
//                }
//
//                for row in 0..<board.ROWS{
//                    for col in 0..<board.COLS{
//
//                        let defendingChessPiece = board.board[row][col]
//                        if defendingChessPiece.geometry is SCNSphere {
//                            continue
//                        }
//
//                        if !defendingChessPiece.isWhite{
//                            continue
//                        }
//
//                        let defendingIndex = BoardIndex(row: row, col: col)
...
//                }
//
//                move(piece: attackingChessPiece, sourceIndex: source, destIndex: attackedIndex)
//                return true
//            }
//        }
//        return false
